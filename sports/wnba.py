...
def getData():
    events_data = []
    urls = espn.get_current_scoreboard_urls(league='wnba')
    ...
    for event in data["events"]:
        ...
        print(getOdds.main('basketball', 'wnba', event, short_detail))
        event_data["odds"] = getOdds.main('basketball', 'wnba', event, short_detail)
