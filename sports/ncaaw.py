...
def getData(conferenceID):
    ...
    for event in data["events"]:
        ...
        print(getOdds.main('basketball', 'womens-college-basketball', event, short_detail))
        event_data["odds"] = getOdds.main('basketball', 'womens-college-basketball', event, short_detail)
